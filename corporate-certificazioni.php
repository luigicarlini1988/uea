...
<head>
    ...
    <title>Uomo Ambiente | Certificazioni</title>
...
<body>
    ...
    <section id="certificazioni-esplosa">

        <div class="foglio flex top-title">
            <div class="col-half">
                <p class="subtitle main-blu">Le nostre</p>
                <p class="titles1 dark-blu">Certificazioni</p>
    ...
    <?php
        include ('incl/divider-section.html');
     ?>
